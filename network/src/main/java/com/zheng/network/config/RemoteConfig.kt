...
package com.zheng.network.config
...
class RemoteConfig {
    ...
    companion object {
        ...
        fun initConfig(netConfig: NetConfig) {
    ...
    @Provides
    @Singleton
    fun provideOkHttpClient(builder: OkHttpClient.Builder, loggingInterceptor: HttpLoggingInterceptor, cache: Cache): OkHttpClient {
        return builder
            //连接超时时间（默认10秒）
