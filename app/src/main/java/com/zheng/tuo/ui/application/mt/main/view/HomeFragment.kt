...
//双重校验锁式
class HomeFragment private constructor() : BaseFragment<FragmentHomeBinding, EmptyViewModel>(R.layout.fragment_home) {
    override fun initialization() {

    }

    companion object {
        val instance: HomeFragment by lazy(mode = LazyThreadSafetyMode.SYNCHRONIZED) { HomeFragment() }
    }
