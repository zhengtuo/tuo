...
//双重校验锁式
class MyFragment private constructor() : BaseFragment<FragmentHomeBinding, EmptyViewModel>(R.layout.fragment_home) {
    override fun initialization() {

    }

    companion object {
        val instance: MyFragment by lazy(mode = LazyThreadSafetyMode.SYNCHRONIZED) { MyFragment() }
    }
